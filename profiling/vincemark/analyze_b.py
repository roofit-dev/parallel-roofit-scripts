...
# @Last Modified time: 2017-06-28 10:36:00
...
rsync --progress --include='*/' --include='*/*/' --include='timing*.json' --exclude='*' -zavr nikhef:project_atlas/apcocsm_code/profiling/vincemark/vincemark_b ./
"""

basepath = Path.home() / 'projects/apcocsm/code/profiling/vincemark/vincemark_b'
...
fpgloblist = [basepath.glob('%i.allier.nikhef.nl/*.json' % i)
              for i in range(18550595, 18550668)]
