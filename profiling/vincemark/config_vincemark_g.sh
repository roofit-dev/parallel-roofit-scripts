...
# @Last Modified time: 2017-07-06 14:07:56

# set g: same as f, but again with interleave = 0 and now with CPU timing too.
#        Unlike b_cpu, this run does wall clock timing as well.

export run_id=vincemark_g

export run_script_name="run_root_vincemark.sh"

ws_base_path="$HOME/project_atlas/vince"
