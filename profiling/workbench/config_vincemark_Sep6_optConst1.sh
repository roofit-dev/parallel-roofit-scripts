...
# @Last Modified time: 2017-09-19 07:36:03

# Previous vincemark set was _g. Now switched to following naming scheme of
# Vince's workspace directories.

export run_id=vincemark_Sep6_optConst1

export run_script_name="run_root_workbench.sh"

ws_base_path="$HOME/project_atlas/vince/Sep6"

workspace_filepath=$ws_base_path/workspace.root

workspace_name="BinnedWorkspace"
...
# no longer necessary, Vince does this now
...
for cpu_affinity in true false; do
