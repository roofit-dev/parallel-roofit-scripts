...
# @Last Modified time: 2017-09-19 08:18:31
...
"""
cd ~/projects/apcocsm/code/profiling/workbench && rsync --progress --include='*/' --include='*/*/' --include='timing*.json' --exclude='*' -zavr nikhef:project_atlas/apcocsm_code/profiling/workbench/vbfComb_a ./ && cd -
"""

basepath = Path.home() / 'projects/apcocsm/code/profiling/workbench/vbfComb_a'
...
fpgloblist = [basepath.glob('%i.allier.nikhef.nl/*.json' % i)
              for i in range(18750495, 18750542)]
