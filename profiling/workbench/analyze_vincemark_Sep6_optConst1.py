...
# @Last Modified time: 2017-09-19 08:12:43
...
"""
cd ~/projects/apcocsm/code/profiling/workbench && rsync --progress --include='*/' --include='*/*/' --include='timing*.json' --exclude='*' -zavr nikhef:project_atlas/apcocsm_code/profiling/workbench/vincemark_Sep6_optConst1 ./ && cd -
"""

basepath = Path.home() / 'projects/apcocsm/code/profiling/workbench/vincemark_Sep6_optConst1'
...
fpgloblist = [basepath.glob('%i.allier.nikhef.nl/*.json' % i)
              for i in range(18750591, 18750670)]
