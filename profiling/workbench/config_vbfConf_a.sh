...
# @Last Modified time: 2017-09-19 07:42:00

# set a: same HWWRun2GGF_c, but with vbf combined workspace; optConst 0 and 1

export run_id=vbfComb_a

export run_script_name="run_root_workbench.sh"

ws_base_path="$HOME/project_atlas/carsten/simple"

workspace_filepath="${ws_base_path}/vbf.root"
