...
# @Last Modified time: 2017-05-31 14:23:15
...
rsync -avr nikhef:project_atlas/apcocsm_code/profiling/numIntSet_timing/unbinned_scaling2_f_scaling_overhead_time_num_ints_OFF ./
"""

basepath = Path.home() / 'projects/apcocsm/code/profiling/numIntSet_timing/unbinned_scaling2_f_scaling_overhead_time_num_ints_OFF'
...
fpgloblist = [basepath.glob('%i.allier.nikhef.nl/*.json' % i)
              for i in range(18459804, 18459947)]
