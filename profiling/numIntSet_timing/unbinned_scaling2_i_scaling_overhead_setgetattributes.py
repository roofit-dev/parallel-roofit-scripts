...
# @Last Modified time: 2017-06-01 15:14:22
...
rsync -zavr nikhef:project_atlas/apcocsm_code/profiling/numIntSet_timing/unbinned_scaling2_i_scaling_overhead_setgetattributes ./
"""

basepath = Path.home() / 'projects/apcocsm/code/profiling/numIntSet_timing/unbinned_scaling2_i_scaling_overhead_setgetattributes'
...
fpgloblist = [basepath.glob('%i.allier.nikhef.nl/*.json' % i)
              for i in range(18464648, 18464791)]
