...
rsync -zavr nikhef:'project_atlas/apcocsm_code/profiling/numIntSet_timing/unbinned_scaling2_xx_quick_test_*' ./
"""

basebasepath = Path.home() / 'projects/apcocsm/code/profiling/numIntSet_timing/'
xx_quick_test_dirs = basebasepath.glob('unbinned_scaling2_xx_quick_test_*')

basepath = sorted(xx_quick_test_dirs)[-1]
