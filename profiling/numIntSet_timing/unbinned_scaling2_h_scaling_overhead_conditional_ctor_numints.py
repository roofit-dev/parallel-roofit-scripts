...
# @Last Modified time: 2017-06-01 10:27:15
...
rsync -zavr nikhef:project_atlas/apcocsm_code/profiling/numIntSet_timing/unbinned_scaling2_h_scaling_overhead_conditional_ctor_numints ./
"""

basepath = Path.home() / 'projects/apcocsm/code/profiling/numIntSet_timing/unbinned_scaling2_h_scaling_overhead_conditional_ctor_numints'
...
fpgloblist = [basepath.glob('%i.allier.nikhef.nl/*.json' % i)
              for i in range(18463507, 18463650)]
