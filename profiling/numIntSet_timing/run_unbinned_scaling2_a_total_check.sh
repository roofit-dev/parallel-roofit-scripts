...
# @Last Modified time: 2017-05-05 08:55:49

#PBS -l nodes=1:ppn=8
#PBS -o pbs_log/run_unbinned_scaling2

# after unbinned_scaling2 run, where total timings for num_cpu > 1 were very
# high, these runs check whether the code still runs properly without numerical
# integral timing, but with forced numerical integrals for consistency

run_id=unbinned_scaling2_a_total_check
