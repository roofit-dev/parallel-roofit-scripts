...
# @Last Modified time: 2017-05-05 11:21:05
...
fpiter = itertools.chain( # the five runs on the top here were not run in the end, useless
                         basepath.glob('18317492.allier.nikhef.nl/*.json'),
                         basepath.glob('18317493.allier.nikhef.nl/*.json'),
                         basepath.glob('18317494.allier.nikhef.nl/*.json'),
                         basepath.glob('18317495.allier.nikhef.nl/*.json'),
                         basepath.glob('18317496.allier.nikhef.nl/*.json'),
                         # basepath.glob('18317499.allier.nikhef.nl/*.json'),  # run with only 1 core
